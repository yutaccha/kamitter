            ...
            <div class="p-contents__area">
                ...
                <section class="c-tab">
                    <ul class="c-tab__list">
                        <li class="c-tab__item c-tab__item--active" @click="tab=1">自動フォロー</li>
                        <li class="c-tab__item" @click="tab=2">自動アンフォロー</li>
                        <li class="c-tab__item" @click="tab=3">自動いいね</li>
                        <li class="c-tab__item" @click="tab=4">自動ツイート</li>
                        <li class="c-tab__item" @click="tab=5">キーワード登録</li>
                    </ul>
                </section>

                <section class="p-dashboard">

                    <div class="c-panel u-color__bg--white" v-show="tab===1">
                        <div class="c-status">
                    ...
                    <div class="p-dashboard__panel" v-show="tab===2">
                        <div class="c-status">
                            <p class="c-status__show">稼働中</p>
                    ...
                    <div class="p-dashboard__panel" v-show="tab===3">
                        <div class="c-status">
                            <p class="c-status__show">稼働中</p>
                            <button class="c-status__button c-button c-button--start">サービス開始</button>
                            <button class="c-status__button c-button c-button--cancel">停止</button>
                    ...
                    <div class="p-dashboard__panel" v-show="tab===4">
                        <div class="c-status">
                            <p class="c-status__show">稼働中</p>
                            <button class="c-status__button c-button c-button--start">サービス開始</button>
                            <button class="c-status__button c-button c-button--cancel">停止</button>
                    ...
                    <div class="p-dashboard__panel" v-show="tab===5">
                        <table class="c-table">
